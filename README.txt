...
Supported Platforms
-------------------
OpenDUNE is written in ANSI C (C89), and only requires SDL/SDL2/SDL3 to run. In result,
 OpenDUNE should run on all platforms supported by SDL, SDL2 or SDL3. SDL3 is currently
